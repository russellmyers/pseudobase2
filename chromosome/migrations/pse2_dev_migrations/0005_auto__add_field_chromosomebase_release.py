...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChromosomeBase.release'
        db.add_column(u'chromosome_chromosomebase', 'release',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChromosomeBase.release'
        db.delete_column(u'chromosome_chromosomebase', 'release')
    ...
    models = {
        u'chromosome.chromosomebase': {
            ...
            'release': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '20'}),
