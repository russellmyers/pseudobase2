...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChromosomeBatchImportProcess'
        db.create_table(u'chromosome_chromosomebatchimportprocess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'chromosome', ['ChromosomeBatchImportProcess'])

        # Adding model 'ChromosomeBatchImportLog'
        db.create_table(u'chromosome_chromosomebatchimportlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('run_microseconds', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('file_path', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('base_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('clip_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chromosome.ChromosomeBatchImportProcess'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='P', max_length=1, db_index=True)),
            ('records_read', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
            ('chromebase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chromosome.ChromosomeBase'], null=True, blank=True)),
            ('vcf_meta_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'chromosome', ['ChromosomeBatchImportLog'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ChromosomeBatchImportProcess'
        db.delete_table(u'chromosome_chromosomebatchimportprocess')

        # Deleting model 'ChromosomeBatchImportLog'
        db.delete_table(u'chromosome_chromosomebatchimportlog')
