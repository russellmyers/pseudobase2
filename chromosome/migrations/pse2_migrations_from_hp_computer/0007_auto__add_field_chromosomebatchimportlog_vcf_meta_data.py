...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChromosomeBatchImportLog.vcf_meta_data'
        db.add_column(u'chromosome_chromosomebatchimportlog', 'vcf_meta_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChromosomeBatchImportLog.vcf_meta_data'
        db.delete_column(u'chromosome_chromosomebatchimportlog', 'vcf_meta_data')
