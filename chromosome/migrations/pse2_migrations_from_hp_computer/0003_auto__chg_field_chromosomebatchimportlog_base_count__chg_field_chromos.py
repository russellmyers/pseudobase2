...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChromosomeBatchImportLog.base_count'
        db.alter_column(u'chromosome_chromosomebatchimportlog', 'base_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ChromosomeBatchImportLog.clip_count'
        db.alter_column(u'chromosome_chromosomebatchimportlog', 'clip_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
        # Adding field 'ChromosomeBatchImportProcess.original_request'
        db.add_column(u'chromosome_chromosomebatchimportprocess', 'original_request',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ChromosomeBatchImportLog.base_count'
        db.alter_column(u'chromosome_chromosomebatchimportlog', 'base_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'ChromosomeBatchImportLog.clip_count'
        db.alter_column(u'chromosome_chromosomebatchimportlog', 'clip_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
        # Deleting field 'ChromosomeBatchImportProcess.original_request'
        db.delete_column(u'chromosome_chromosomebatchimportprocess', 'original_request')
